...
--
-- Host: mysql
-- Tempo de geração: 20-Set-2025 às 11:14
...
INSERT INTO `product` (`id`, `supplier_id`, `name`, `price`, `has_ingredients`, `description`) VALUES
(1, NULL, 'Chicken Salad', 10, 1, 'A healthy chicken salad with fresh vegetables.'),
(2, NULL, 'Beef Burger', 15, 1, 'A juicy beef burger with cheese and lettuce.'),
(3, 2, 'Coca-Cola', 5, 0, 'A refreshing Coca-Cola beverage.'),
(4, NULL, 'French Fries', 7, 1, 'Crispy golden french fries.'),
(5, NULL, 'Caesar Salad', 12, 1, 'A classic Caesar salad with romaine lettuce and croutons.'),
(6, 4, 'Pepsi', 4.5, 0, 'Refreshing cola drink.'),
(7, NULL, 'Cheese Pizza', 18, 1, 'Delicious cheese pizza with tomato sauce.'),
(8, NULL, 'Grilled Chicken Sandwich', 13, 1, 'Sandwich with grilled chicken and fresh vegetables.'),
(9, 7, 'Orange Juice', 6, 0, 'Freshly squeezed orange juice.'),
(10, 6, 'Chocolate Cake', 8, 0, 'Rich and moist chocolate cake.'),
(11, NULL, 'Vegetable Soup', 9, 1, 'Hearty soup with fresh vegetables.'),
(12, 7, 'Ice Cream', 6.5, 0, 'Creamy vanilla ice cream.'),
(13, NULL, 'Fish and Chips', 16, 1, 'Crispy fish with french fries.'),
(14, 4, 'Mineral Water', 3, 0, 'Pure natural mineral water.'),
(15, 3, 'Fruit Salad', 7.5, 0, 'Fresh mix of seasonal fruits.');
