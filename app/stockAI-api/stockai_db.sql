...
VALUES (
        'DoctrineMigrations\\Version20250920074522',
        '2025-09-20 07:45:30',
        135
    );
...
VALUES (1, 25, '2023-10-01 12:00:00'),
...
VALUES (
        ...
        'https://www.allrecipes.com/thmb/aPy_MqN4GgyO27vh98ns1pXaIWg=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/8499-Best-Chicken-Salad-DDMFS-3X4-11915-d36a5b98b1e041b3b48b62ecdfa6029e.jpg'
    ),
    (
        2,
        NULL,
        ...
        15,
        1,
        'A juicy beef burger with cheese and lettuce.',
        'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=1899&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        3,
        2,
        ...
        5,
        0,
        'A refreshing Coca-Cola beverage.',
        'https://gostobastante.pt/wp-content/uploads/2023/03/Prancheta-1.png'
    ),
    (
        4,
        NULL,
        ...
        'https://plus.unsplash.com/premium_photo-1672774750509-bc9ff226f3e8?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        5,
        NULL,
        ...
        12,
        1,
        'A classic Caesar salad with romaine lettuce and croutons.',
        'https://images.unsplash.com/photo-1725030660031-585ea459d55f?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        6,
        4,
        ...
        'https://images.unsplash.com/photo-1553456558-aff63285bdd1?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        7,
        NULL,
        ...
        'https://images.unsplash.com/photo-1712652080841-9e480a2c43ec?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        8,
        NULL,
        ...
        13,
        1,
        'Sandwich with grilled chicken and fresh vegetables.',
        'https://images.unsplash.com/photo-1757961048411-73703e333d25?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        9,
        7,
        ...
        'https://plus.unsplash.com/premium_photo-1667543228378-ec4478ab2845?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        10,
        6,
        ...
        'https://plus.unsplash.com/premium_photo-1715015440855-7d95cf92608a?q=80&w=988&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        11,
        NULL,
        ...
        9,
        1,
        'Hearty soup with fresh vegetables.',
    ...
    (
        ...
        'https://plus.unsplash.com/premium_photo-1690440686714-c06a56a1511c?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        13,
        NULL,
        ...
        16,
        1,
        'Crispy fish with french fries.',
        'https://plus.unsplash.com/premium_photo-1694108747175-889fdc786003?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        14,
        4,
        ...
        'https://images.unsplash.com/photo-1638688569176-5b6db19f9d2a?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    ),
    (
        15,
        3,
        ...
        7.5,
        0,
        'Fresh mix of seasonal fruits.',
        'https://plus.unsplash.com/premium_photo-1664478279991-832059d65835?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
    );
...
VALUES (
        ...
        '123456789',
        'https://api.mercadocentral.com',
        'abc123xyz-efsdfsfss-123456',
        'GET'
    ),
    (
        2,
        ...
        '(11) 5555-6666',
        '(11) 99999-8888',
        'contato@supermercadobompreco.com',
        'Rua Secundária, 456, Centro, São Paulo, SP',
        '987654321',
        'https://api.supermercadobompreco.com',
        'def456uvw-efsdfsfss-654321',
        'POST'
    ),
    (
        3,
        ...
        '(11) 7777-8888',
        '(11) 99999-8888',
        'contato@hortifrutnatural.com',
        'Rua Terceira, 789, Centro, São Paulo, SP',
        '456789123',
        'https://api.hortifrutnatural.com',
        'ghi789rst-efsdfsfss-789123',
        'GET'
    ),
    (
        4,
        ...
        '(11) 2222-3333',
        '(11) 98888-7777',
        'vendas@distribuidorabebidas.com',
        'Av. das Nações, 1000, Industrial, São Paulo, SP',
        '654321987',
        'https://api.distribuidorabebidas.com',
        'jkl012mno-efsdfsfss-321987',
        'POST'
    ),
    (
        5,
        'Frigorífico Prime Carne',
        '(11) 4444-5555',
        '(11) 97777-6666',
        'compras@primecarne.com',
        'Rua dos Abatedouros, 250, Zona Rural, São Paulo, SP',
        '789123456',
        'https://api.primecarne.com',
        'pqr345stu-efsdfsfss-789456',
        'GET'
    ),
    (
        6,
        ...
        '(11) 6666-7777',
        '(11) 96666-5555',
        'contato@paoquente.com',
        'Rua dos Padeiros, 75, Centro, São Paulo, SP',
        '321654987',
        'https://api.paoquente.com',
        'vwx678yza-efsdfsfss-654987',
        'POST'
    ),
    (
        7,
        ...
        '(11) 95555-4444',
        'sac@leitebom.com',
        'Fazenda Santa Maria, KM 50, Rodovia SP-300, São Paulo, SP',
        '987123654',
        'https://api.leitebom.com',
        'bcd901efg-efsdfsfss-987654',
        'GET'
    ),
    (
        8,
...
--
ALTER TABLE `invoice` MODIFY `id` int NOT NULL AUTO_INCREMENT;
